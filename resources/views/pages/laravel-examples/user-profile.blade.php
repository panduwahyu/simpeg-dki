                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card border shadow-sm p-3 h-100">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item px-0 py-1">
                                    <strong>Status:</strong> {{ auth()->user()->role ?? 'Pegawai' }}
                                </li>
                                <li class="list-group-item px-0 py-1">
                                    <strong>Wilayah:</strong> {{ auth()->user()->wilayah ?? '-' }}
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card border shadow-sm p-3 h-100">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item px-0 py-1">
                                    <strong>NIP BPS:</strong> {{ auth()->user()->nip_bps ?? '-' }}
                                </li>
                                <li class="list-group-item px-0 py-1">
                                    <strong>NIP:</strong> {{ auth()->user()->nip ?? '-' }}
                                </li>
                                <li class="list-group-item px-0 py-1">
                                    <strong>Unit Kerja:</strong> {{ auth()->user()->unit_kerja ?? '-' }}
                                </li>
                                <li class="list-group-item px-0 py-1">
                                    <strong>Jabatan:</strong> {{ auth()->user()->jabatan ?? '-' }}
                                </li>
                                <li class="list-group-item px-0 py-1">
                                    <strong>Pangkat:</strong> {{ auth()->user()->pangkat ?? '-' }}
                                </li>
                                <li class="list-group-item px-0 py-1">
                                    <strong>Golongan:</strong> {{ auth()->user()->golongan ?? '-' }}
                                </li>
                            </ul>
                        </div>
                    </div>
