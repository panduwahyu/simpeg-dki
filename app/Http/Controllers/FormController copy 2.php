...
class FormController extends Controller
{
    ...
    {
        // Ambil semua JenisDokumen beserta periode terkait
    ...
    /**
     * Simpan dokumen baru dan buat periode terkait
     */
    public function store(Request $request)
    {
        ...
        DB::transaction(function() use ($request) {
            ...
            // 2. Buat periode terkait berdasarkan tipe
            if ($tipe === 'bulanan') {
    ...
    /**
     * Hapus dokumen dan periode terkait
     */
    public function destroy(JenisDokumen $jenisDokumen)
    {
        DB::transaction(function() use ($jenisDokumen) {
            // Hapus periode terkait dulu
            $jenisDokumen->periode()->delete();
            // Hapus dokumen
            $jenisDokumen->delete();
        });

        return redirect()->route('form.index')->with('success', 'Dokumen & Periode berhasil dihapus!');
    }
}
